python ../src/run_pacbio.py --sample test_sample --outdir test_res_all_1 --ccs_bam /SGRNJ03/randd/user/fuxin/Github_repo/Pacbio_Analysis/test/test.bam --bu_pattern T-12U-57B --pacbio_source_path /SGRNJ03/randd/user/fuxin/Github_repo/dev/Pacbio_Analysis --steps run_isoform
